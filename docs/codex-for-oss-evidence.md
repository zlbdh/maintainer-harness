...
| Public evidence link health | `scripts/checks/check-public-evidence-links.ps1` verifies that the project site, external review page, release, pinned issues, readiness monitor workflow, Chinese friend review guide, and key raw evidence files remain reachable before the application evidence is used. |
