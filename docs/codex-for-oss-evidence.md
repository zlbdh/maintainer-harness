...
| Public launch readiness | `docs/demo.md`, `docs/share.md`, `docs/launch-kit.md`, `docs/launch-log.md`, the `v0.1.1` release, issues `#5` and `#6`, labels, and the public profile README at `https://github.com/zlbdh/zlbdh` make the repository easier to try, share, critique, and contribute to without artificial star growth. |
