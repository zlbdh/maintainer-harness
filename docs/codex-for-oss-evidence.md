...
| Public launch readiness | `docs/demo.md`, `docs/launch-kit.md`, the `v0.1.1` release, issue `#5`, and the public profile README at `https://github.com/zlbdh/zlbdh` make the repository easier to try, share, and critique without artificial star growth. |
...
- The repository has a policy-safe launch path: a validated demo, a launch-ready release, GitHub topics, a public feedback issue, and a GitHub profile README entry.
