...
| Maintainer review handoff | `docs/maintainer-review-kit.md` gives outside reviewers a five-minute path to inspect the workflow shape, run the demo, or review the security boundary. |
