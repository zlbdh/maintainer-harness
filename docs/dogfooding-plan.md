...
| --- | --- | --- |
| Days 1-7 | Run the harness on synthetic issue-to-change and security-review examples. | Updated `examples/sample-change/`, validation reports summarized in docs, and roadmap issues. |
| Days 8-14 | Add a pull-request review packet example with explicit worker scope and reviewer acceptance evidence. | New example change packet and schema coverage notes. |
