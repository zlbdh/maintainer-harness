...
| Hour 2 | Generate the review request packet and send the maintainer review kit plus worker-output example to reviewers who prefer a structured 5-minute path. | "Pick one path: inspect, run, or review security boundaries." | Public issue comment or first-run report URL. |
