...
| 2026-06-02 | GitHub release | https://github.com/zlbdh/maintainer-harness/releases/tag/v0.1.6 | Planned | Release anchors the synthetic release workflow example. | Publish after CI passes. |
| 2026-06-02 | Synthetic release workflow example | https://github.com/zlbdh/maintainer-harness/tree/main/examples/release-workflow | Prepared | Release notes, skipped checks, rollback, and postmortem-ready evidence now have a public packet example. | Close or update issue #4 after CI passes. |
