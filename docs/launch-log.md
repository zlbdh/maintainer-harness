...
| 2026-06-02 | Synthetic PR review example | https://github.com/zlbdh/maintainer-harness/tree/main/examples/issue-to-review | Prepared | Issue intake, impact mapping, worker scope, and reviewer acceptance evidence now have a public packet example. | Close or update issue #1 after CI passes. |
| 2026-06-02 | GitHub release | https://github.com/zlbdh/maintainer-harness/releases/tag/v0.1.4 | Planned | Release will anchor the issue-to-review packet example. | Publish after CI passes. |
