...
| Local reports to public repository | Generated reports are ignored; shared summaries must follow `docs/security/redaction-patterns.md`. |
...
| Sensitive data committed to the public control repo | Secrets, customer data, or private paths become public. | `.gitignore`, `check-public-ready.ps1`, `check-security-posture.ps1`, and `docs/security/redaction-patterns.md`. |
...
- Shared validation summaries are manually redacted before being copied into tracked files.
